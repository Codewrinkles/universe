/**
 * EmptyState - Nova introduction shown when starting a new conversation
 *
 * This is the welcome screen users see when they land on /nova/c/new.
 * It introduces Nova (the AI coach) and sets expectations.
 */
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 py-8">
      ...
      <h1 className="text-xl font-semibold text-text-primary mb-2">
        Hey! I'm Nova, your learning coach.
      </h1>
